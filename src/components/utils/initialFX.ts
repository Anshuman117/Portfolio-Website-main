...
function getSplitText(): SplitTextConstructor | undefined {
  return (window as Window & { SplitText?: SplitTextConstructor }).SplitText;
}
...
function LoopText(text1: SplitTextInstance, text2: SplitTextInstance) {
